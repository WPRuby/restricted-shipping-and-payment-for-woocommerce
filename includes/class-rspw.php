...
class RSPW {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_get_shipping_rule_type_operators', $plugin_admin, 'get_shipping_rule_type_operators' );
		$this->loader->add_action( 'wp_ajax_get_payment_rule_type_operators', $plugin_admin, 'get_payment_rule_type_operators' );
	}
